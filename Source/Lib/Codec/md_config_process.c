    ...
    if (pcs->frm_hdr.quantization_params.using_qmatrix) {
        ...
        switch (pcs->scs->static_config.tune) {
            ...
            default:
                ...
                pcs->frm_hdr.quantization_params.qm[AOM_PLANE_U] = aom_get_qmlevel(base_qindex + pcs->frm_hdr.quantization_params.delta_q_ac[AOM_PLANE_U], min_chroma_qmlevel, min_chroma_qmlevel);

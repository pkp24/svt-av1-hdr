...
static void svt_av1_qm_init(PictureParentControlSet *pcs) {
    ...
    pcs->frm_hdr.quantization_params.qm[AOM_PLANE_Y] = pcs->scs->static_config.tune == 3 ?
        psy_get_qmlevel(base_qindex, min_qmlevel, max_qmlevel, 0) :
        aom_get_qmlevel(base_qindex, min_qmlevel, max_qmlevel);
        ...
        pcs->frm_hdr.quantization_params.qm[AOM_PLANE_U] = pcs->scs->static_config.tune == 3 ?
            psy_get_qmlevel(base_qindex + pcs->frm_hdr.quantization_params.delta_q_ac[AOM_PLANE_U],
                min_chroma_qmlevel,
                max_chroma_qmlevel,
                1) :
            aom_get_qmlevel(base_qindex + pcs->frm_hdr.quantization_params.delta_q_ac[AOM_PLANE_U],
                min_chroma_qmlevel,
                max_chroma_qmlevel);
        pcs->frm_hdr.quantization_params.qm[AOM_PLANE_V] = pcs->scs->static_config.tune == 3 ?
            psy_get_qmlevel(base_qindex + pcs->frm_hdr.quantization_params.delta_q_ac[AOM_PLANE_V],
                min_chroma_qmlevel,
                max_chroma_qmlevel,
                1) :
            aom_get_qmlevel(base_qindex + pcs->frm_hdr.quantization_params.delta_q_ac[AOM_PLANE_V],
                min_chroma_qmlevel,
                max_chroma_qmlevel);
#if DEBUG_QM_LEVEL

...
| **Tune**                         | --tune                      | [0-4]                          | 1           | Optimize the encoding process for different desired outcomes [0 = VQ, 1 = PSNR, 2 = SSIM, 3 = Subjective SSIM, 4 = Still Picture]                                                    |
...
| **PsyRd**                        | --psy-rd                         | [0.0-8.0]  | 1.0         | Use psychovisual rate distortion optimization                                                                                                        |
